...
export default function StaffActionsDropdown({ staff }: { staff: Staff }) {
              ...
              <div className="py-1">
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    if (
                      confirm(
                        `Tens a certeza que queres remover ${staff.name}?`
                      )
                    ) {
                      console.log("Eliminar staff:", staff.id);
                      // aqui no futuro podes chamar o deleteStaff do hook/API
                    }
                  }}
                >
